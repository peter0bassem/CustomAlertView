...
class AlertView: UIView {
    ...
    var alertViewProtocol: AlertViewDelegate?
    ...
    func showAlert(title: String, message: String, alertType: AlertType, doneClick: AlertViewDelegate) {
        alertViewProtocol = doneClick
    ...
    @IBAction func onClickDone(_ sender: Any) {
        if alertViewProtocol != nil {
            alertViewProtocol?.doneButtonClick()
        }
